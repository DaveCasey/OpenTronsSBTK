package com.opentrons.sbtk.Bluetooth;
 ...
 */
public class BluetoothSerialService extends SBTKService{
	// Debugging
	...
	public void write(byte[] out) {
		...
		synchronized (this) {
			if (mState != STATE_CONNECTED){
				Log.d(TAG,"tried to write... mState="+mState);
				return;
			}
			//r = mConnectedThread;
			Log.d(TAG, "r = mListener");
			r = mListener;
			
		}
		// Perform the write unsynchronized
		String out_str = String.valueOf(out);
		Log.d(TAG,"writing: "+out_str);
		r.write(out);
	}
